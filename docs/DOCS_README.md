...
| [`superpowers/specs/2026-09-08-model-backend-registry-design.md`](superpowers/specs/2026-09-08-model-backend-registry-design.md) | T3 | Proposed extensible backend protocol, explicit registry, and Ridge protocol test | proposed design |
