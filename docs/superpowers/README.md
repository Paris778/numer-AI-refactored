...
| [`Extensible model backend registry`](specs/2026-09-08-model-backend-registry-design.md) | Proposed | `nmr/model_backend_protocol.py`, `nmr/model_backend_registry.py`, `nmr/model_backend_trees.py`, `nmr/model_backend_ridge.py`, `nmr/models.py`; architecture model-backend section |
