...
Submissions are combined into a [Meta Model](https://docs.numer.ai/numerai-crypto/scoring/definitions#meta-models) that Numerai uses to trade.
...
See [model upload](https://docs.numer.ai/numerai-tournament/submissions/model-uploads) section for more details.
