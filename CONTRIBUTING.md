...
versions in the verified venv (green full suite as of 2026-08-16; 976 tests
after the 2026-08-19 coverage-hardening + parity-depth work). Upgrading a pin is a deliberate act, never a casual `pip install -U`:
