...
def render_report(
    ...
    out.append(_table(
        ...
        [
            {"asset": "train.parquet",
             "official_description": "Data used to train your model (static)"},
            {"asset": "validation.parquet",
             "official_description": "Data used to validate or train your model; expands every week"},
            {"asset": "live.parquet",
             "official_description": "The live data your model predicts on; changes daily"},
            {"asset": "features.json",
             "official_description": "Statistics about each feature + pre-made feature sets"},
            {"asset": "train_benchmark_models.parquet",
             "official_description": "Benchmark model predictions for some train data"},
            {"asset": "validation_benchmark_models.parquet",
             "official_description": "All benchmark model predictions for validation data"},
            {"asset": "live_benchmark_models.parquet",
             "official_description": "All benchmark model predictions for live data"},
            {"asset": "meta_model.parquet",
             "official_description": "Meta Model insights (MMC); only available from era 1133 onwards"},
        ],
    ))
    out.append("")
