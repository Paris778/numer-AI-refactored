...
3. **Pre-sign-off gate** (mandatory before delivering work) — full 650-test suite plus the real-data benchmark smoke (`benchmark_runner.py --fast-mode` → `artifacts/*_smoke.csv`).
