...
**Stack:** Python 3.11+ · Polars · LightGBM / XGBoost · NumPy / SciPy / scikit-learn · `numerai-tools` · `numerapi` · cloudpickle · pytest (321 tests)
...
├── tests/                     # 321 tests (unit / parity / determinism / real-data tests)
