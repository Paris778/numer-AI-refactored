...
**Stack:** Python 3.11+ · Polars · LightGBM / XGBoost · NumPy / SciPy / scikit-learn · `numerai-tools` · `numerapi` · cloudpickle · pytest (339 tests)
...
├── tests/                     # 339 tests (unit / parity / determinism / real-data tests)
