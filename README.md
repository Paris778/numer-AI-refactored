...
**Stack:** Python 3.11+ · Polars · LightGBM / XGBoost / CatBoost · NumPy / SciPy / scikit-learn · `numerai-tools` · `numerapi` · cloudpickle · Streamlit / Plotly · pytest (484 tests)
...
├── tests/                     # 484 tests (unit / parity / determinism / real-data tests)
