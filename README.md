...
**Stack:** Python 3.11+ · Polars · LightGBM / XGBoost / CatBoost · NumPy / SciPy / scikit-learn · `numerai-tools` · `numerapi` · cloudpickle · Streamlit / Plotly · pytest (453 tests)
...
├── tests/                     # 453 tests (unit / parity / determinism / real-data tests)
