...
**Stack:** Python 3.11+ · Polars · LightGBM / XGBoost · NumPy / SciPy / scikit-learn · `numerai-tools` · `numerapi` · cloudpickle · pytest (311 tests)
...
├── tests/                     # 311 tests (unit / parity / determinism / real-data tests)
