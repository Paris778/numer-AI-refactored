...
**Stack:** Python 3.11+ · Polars · LightGBM / XGBoost · NumPy / SciPy / scikit-learn · `numerai-tools` · `numerapi` · cloudpickle · pytest (395 tests)
...
├── tests/                     # 395 tests (unit / parity / determinism / real-data tests)
