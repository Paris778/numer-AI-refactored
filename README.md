...
**Stack:** Python 3.11+ · Polars · LightGBM / XGBoost / CatBoost · NumPy / SciPy / scikit-learn · `numerai-tools` · `numerapi` · cloudpickle · Streamlit / Plotly · pytest (438 tests)
...
├── tests/                     # 438 tests (unit / parity / determinism / real-data tests)
