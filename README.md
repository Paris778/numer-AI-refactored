...
**Stack:** Python 3.11+ · Polars · LightGBM / XGBoost · NumPy / SciPy / scikit-learn · `numerai-tools` · `numerapi` · cloudpickle · pytest (393 tests)
...
├── tests/                     # 393 tests (unit / parity / determinism / real-data tests)
