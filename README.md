...
**Stack:** Python 3.11+ · Polars · LightGBM / XGBoost · NumPy / SciPy / scikit-learn · `numerai-tools` · `numerapi` · cloudpickle · pytest (326 tests)
...
├── tests/                     # 326 tests (unit / parity / determinism / real-data tests)
