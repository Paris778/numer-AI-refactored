...
**Stack:** Python 3.11+ · Polars · LightGBM / XGBoost · NumPy / SciPy / scikit-learn · `numerai-tools` · `numerapi` · cloudpickle · pytest (363 tests)
...
├── tests/                     # 363 tests (unit / parity / determinism / real-data tests)
