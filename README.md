...
**Stack:** Python 3.11+ · Polars · LightGBM / XGBoost / CatBoost · NumPy / SciPy / scikit-learn · `numerai-tools` · `numerapi` · cloudpickle · pytest (408 tests)
...
├── tests/                     # 408 tests (unit / parity / determinism / real-data tests)
