...
**Stack:** Python 3.11+ · Polars · LightGBM / XGBoost · NumPy / SciPy / scikit-learn · `numerai-tools` · `numerapi` · cloudpickle · pytest (343 tests)
...
├── tests/                     # 343 tests (unit / parity / determinism / real-data tests)
