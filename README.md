...
**Stack:** Python 3.11+ · Polars · LightGBM / XGBoost · NumPy / SciPy / scikit-learn · `numerai-tools` · `numerapi` · cloudpickle · pytest (336 tests)
...
├── tests/                     # 336 tests (unit / parity / determinism / real-data tests)
