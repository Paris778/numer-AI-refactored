...
**Stack:** Python 3.11+ · Polars · LightGBM / XGBoost / CatBoost · NumPy / SciPy / scikit-learn · `numerai-tools` · `numerapi` · cloudpickle · Streamlit / Plotly · pytest (416 tests)
...
├── tests/                     # 416 tests (unit / parity / determinism / real-data tests)
