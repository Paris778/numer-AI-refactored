...
**Stack:** Python 3.11+ · Polars · LightGBM / XGBoost · NumPy / SciPy / scikit-learn · `numerai-tools` · `numerapi` · cloudpickle · pytest (388 tests)
...
├── tests/                     # 388 tests (unit / parity / determinism / real-data tests)
