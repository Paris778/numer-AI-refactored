...
**Stack:** Python 3.11+ · Polars · LightGBM / XGBoost · NumPy / SciPy / scikit-learn · `numerai-tools` · `numerapi` · cloudpickle · pytest (400 tests)
...
├── tests/                     # 400 tests (unit / parity / determinism / real-data tests)
