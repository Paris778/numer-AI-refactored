...
**Stack:** Python 3.11+ · Polars · LightGBM / XGBoost · NumPy / SciPy / scikit-learn · `numerai-tools` · `numerapi` · cloudpickle · pytest (316 tests)
...
├── tests/                     # 316 tests (unit / parity / determinism / real-data tests)
