...
**Stack:** Python 3.11+ · Polars · LightGBM / XGBoost · NumPy / SciPy / scikit-learn · `numerai-tools` · `numerapi` · cloudpickle · pytest (401 tests)
...
├── tests/                     # 401 tests (unit / parity / determinism / real-data tests)
